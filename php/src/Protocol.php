...
final class Protocol
{
    ...
    public const AUTH_CERTIFICATE = 4;
    public const AUTH_GSSAPI = 5;
    public const AUTH_SSPI = 6;
    public const AUTH_LDAP = 7;
    public const AUTH_SAML = 8;
    public const AUTH_OIDC = 9;
    public const AUTH_MFA_TOTP = 10;
    public const AUTH_CLUSTER_PKI = 11;
