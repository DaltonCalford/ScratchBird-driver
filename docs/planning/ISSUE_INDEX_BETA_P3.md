...
- Add SQLSTATE class-prefix mapping (currently only prefixes message) in `tracks/beta/drivers/r/R/client.R`. -> `docs/planning/driver-checklists/r.md#L6`
- Add conformance tests for full type matrix in `tracks/beta/drivers/r/tests/`. -> `docs/planning/driver-checklists/r.md#L10`
