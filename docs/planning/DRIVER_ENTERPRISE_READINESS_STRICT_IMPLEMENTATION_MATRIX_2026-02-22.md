...
| ODBC-009 | P0 | Verification complete (in-tree ODBC gate executed; BI smoke hook wired, external harness pending) | Missing fully automated BI toolchain/harness in CI | BI runbook automation + conformance + perf/memory checks in CI | Platform Lead + ODBC Team | High | 1w | ODBC-001 .. ODBC-008 |
