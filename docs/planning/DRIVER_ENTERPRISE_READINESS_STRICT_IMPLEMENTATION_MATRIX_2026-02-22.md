...
| ODBC-005 | P0 | Partial | Scroll and positioned cursor semantics limited | Scrollable/forward-only and positioned update/delete in concurrent load | ODBC Team | High | 2–4w | ODBC-003, ODBC-004 |
| ODBC-006 | P1 | Not implemented | Bulk DML and array binding missing | 10k+ row bulk insert/update correctness/performance | ODBC Team | High | 3–5w | ODBC-003 |
| ODBC-007 | P1 | Partial | LOB read/write streaming incomplete | 10MB+ LOB stream upload/download correctness | ODBC Team | High | 3–5w | ODBC-005 |
