...
- [dotnet.md] Replace SQLSTATE class-prefix mapping with spec-complete SQLSTATE mapping in `tracks/alpha/drivers/dotnet/src/ScratchBird.Data/Errors.cs` -> OPEN (2026-02-04)
...
- [python.md] Replace SQLSTATE class-prefix mapping with spec-complete SQLSTATE mapping in `tracks/alpha/drivers/python/src/scratchbird/connection.py` -> OPEN (2026-02-04)
...
- [pascal.md] Provide Base64 unit dependency or inline Base64 implementation for `ScratchBird.Scram` (FPC build fails) -> OPEN (2026-02-06)
