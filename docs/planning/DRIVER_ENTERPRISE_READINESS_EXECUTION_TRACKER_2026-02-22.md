...
| DOTNET-104 | 5 | DOTNET-101 | .NET Team | Finish prepared cache lifecycle and metadata/Lob path; add stale plan invalidation tests | `artifacts/enterprise-readiness/DOTNET-104` | Metadata + cache + LOB conformance matrix | 3–5w | verification_complete |
...
| JDBC-202 | 5 | JDBC-201 | JDBC Team + QA | Expand metadata/protocol parity coverage; refine prepared statement and LOB lifecycle tests | `artifacts/enterprise-readiness/JDBC-202` | JDBC conformance suite pass with parity checks | 4–6w | in_progress |
| JDBC-203 | 5 | DOTNET-101, JDBC-201, DOTNET-102 | Core Runtime + JVM/Platform | Build cross-runtime contract harness and shared expected behavior document | `artifacts/enterprise-readiness/JDBC-203` | Unified .NET/JDBC pooling contract pass | 1w | in_progress |
