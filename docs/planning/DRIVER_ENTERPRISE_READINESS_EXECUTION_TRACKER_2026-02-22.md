...
| ODBC-007 | 2 | ODBC-005 | ODBC Team | Implement large-object bind/read/write streams; verify truncation, encoding, and chunking behavior | `artifacts/enterprise-readiness/ODBC-007` | 10MB+ LOB stream roundtrip suite | 3–5w | in_progress |
