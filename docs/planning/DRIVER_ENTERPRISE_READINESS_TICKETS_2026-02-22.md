...
Priority: P0  
Status: Verification complete (in-tree gate executed; mandatory in-tree BI smoke command enforced)  
...
Priority: P0  
Status: Blocked (cross-runtime gate requires both runtime endpoints and cancel SQL envs; strict gate blocks CI)  
