...
## P1 (Core)
- [x] Replace SQLSTATE class-prefix mapping with spec-complete SQLSTATE mapping in `tracks/p3/drivers/ruby/lib/scratchbird/errors.rb`. Issue: DONE (2026-03-04)
...
- [x] CONN: Add deterministic manager-proxy positive path and SCRAM handshake success/failure verifier tests in `tracks/p3/drivers/ruby/test/test_conn_auth_protocol.rb`. Status: DONE (2026-03-06)
- [x] CONN: Add env-gated manager-proxy and TLS (`verify-ca` / `verify-full`) integration checks in `tracks/p3/drivers/ruby/test/test_integration.rb`. Status: DONE (2026-03-06)
- [x] TXN: Add wire-level `READY` transaction-id transition tests and commit-after-abort state assertions in `tracks/p3/drivers/ruby/test/test_wire_txn_exec.rb`. Status: DONE (2026-03-06)
- [x] EXEC: Add deterministic portal suspend/resume and single-request multi-result framing coverage in `tracks/p3/drivers/ruby/test/test_wire_txn_exec.rb` + `tracks/p3/drivers/ruby/test/test_result_stream.rb`. Status: DONE (2026-03-06)
- [x] EXEC: Add close-complete sequencing assertions for prepared deallocation in `tracks/p3/drivers/ruby/test/test_wire_txn_exec.rb` and env-gated integration roundtrip in `tracks/p3/drivers/ruby/test/test_integration.rb`. Status: DONE (2026-03-06)
- [x] META: Expand metadata family support (`catalogs`, `types`, key/privilege families, `ddl_fields`) and collection-specific restrictions in `tracks/p3/drivers/ruby/lib/scratchbird/metadata.rb` with coverage in `tracks/p3/drivers/ruby/test/test_metadata_execution.rb`. Status: DONE (2026-03-06)
- [x] TYPE: Expand encode/decode + round-trip matrix coverage in `tracks/p3/drivers/ruby/test/test_types.rb`. Status: DONE (2026-03-06)
- [x] ERR/RES: Add env-gated live-depth assertions for SQLSTATE class mapping and socket-drop cleanup behavior in `tracks/p3/drivers/ruby/test/test_integration.rb`. Status: DONE (2026-03-06)
...
- [x] Add conformance tests for full type matrix in `tracks/p3/drivers/ruby/test/`. Issue: DONE (2026-02-04) (Sources: ``)
## P3 (Future)
