...
## P1 (Core)
- [x] Replace SQLSTATE class-prefix mapping with spec-complete SQLSTATE mapping in `tracks/p3/drivers/rust/src/errors.rs`. Issue: DONE (2026-03-04)
...
- [x] Add conformance tests for full type matrix in `tracks/p3/drivers/rust/tests/`. Issue: DONE (2026-02-04) (Sources: ``)
## P3 (Future)
