# Node.js/TypeScript Driver Compatibility Matrix (Template)
...
| Resilience modules | Yes | Implemented | CircuitBreaker, Keepalive, LeakDetector, Telemetry wired into client. |
