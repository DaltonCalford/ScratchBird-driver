# Java JDBC Driver Compatibility Matrix (Template)

Status: Updated (2026-02-06)
Build/Test: 2026-02-06 - `./gradlew build` fails (Unsupported class file major version 65; toolchain/JDK mismatch).
