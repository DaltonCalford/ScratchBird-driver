...
- Define compatibility requirements for php.
...
- PDO errorInfo arrays include SQLSTATE as element 0.
- Statement errorInfo is separate from connection errorInfo.
