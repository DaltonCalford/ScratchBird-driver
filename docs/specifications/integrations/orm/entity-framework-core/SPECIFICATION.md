# Entity Framework Core Integration Specification
...
Checklist: `docs/planning/driver-checklists/dotnet.md` (see Integration Appendix Tasks)
## 1. Goals

- Define compatibility requirements for Entity Framework Core.
