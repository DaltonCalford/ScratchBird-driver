# Rails ActiveRecord Integration Specification
...
Checklist: `docs/planning/driver-checklists/ruby.md` (see Integration Appendix Tasks)
## 1. Goals

- Define compatibility requirements for Rails ActiveRecord.
