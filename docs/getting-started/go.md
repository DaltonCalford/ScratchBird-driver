...
- Best-in-class benchmark: `pgx`
- Authoritative lane spec: `docs/specifications/drivers/language/golang/SPECIFICATION.md`
- Shared release evidence templates: `docs/development/release-evidence/README.md`
- Later verification packet: `docs/development/server-verification/go.md`
