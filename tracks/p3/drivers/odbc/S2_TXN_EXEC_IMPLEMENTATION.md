...
Scope: `tracks/p3/drivers/odbc` lane only.
...
- `./build/tracks/p3/drivers/odbc/scratchbird_odbc_tests --gtest_filter='OdbcTransactionTest.EnvHandleEndTranCommitsConnectedConnections:OdbcExecutionParityTest.ExecuteAndExecDirectPropagateSuccessWithInfo'` -> PASS (2/2)
- `./build/tracks/p3/drivers/odbc/scratchbird_odbc_tests --gtest_filter='OdbcAutocommitTest.*:OdbcTransactionTest.EnvHandleEndTranCommitsConnectedConnections:OdbcExecutionParityTest.ExecuteAndExecDirectPropagateSuccessWithInfo'` -> PASS (4/4)
