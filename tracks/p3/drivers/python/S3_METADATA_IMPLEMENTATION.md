...
1. `PYTHONDONTWRITEBYTECODE=1 pytest -q tracks/p3/drivers/python/tests/test_metadata_execution.py tracks/p3/drivers/python/tests/test_integration.py`
- Result: PASS (`45 passed, 27 skipped`)

2. `PYTHONDONTWRITEBYTECODE=1 pytest -q tracks/p3/drivers/python/tests/test_runtime_contract_gate.py`
- Result: PASS (`3 passed`)

3. `PYTHONDONTWRITEBYTECODE=1 pytest -q tracks/p3/drivers/python/tests`
