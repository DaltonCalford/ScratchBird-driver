...
1. Type codec suite
   ...
   - `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_type_build -FE/tmp/sb_pascal_type_bin ./tracks/p3/drivers/pascal/tests/TypesCodecTests.pas`
...
2. Targeted Pascal lane regression sweep
   ...
   - `  fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU"$build_dir" -FE"$bin_dir" ./tracks/p3/drivers/pascal/tests/${test}.pas >/tmp/${test}.compile.log`
