...
1. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_res_build -FE/tmp/sb_pascal_res_bin ./tracks/p3/drivers/pascal/tests/ResourceResilienceTests.pas`
   - Result: PASS (compile)
...
3. Regression checks on existing client-facing lane tests
   - `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_reg_build -FE/tmp/sb_pascal_reg_bin ./tracks/p3/drivers/pascal/tests/ConnectionAuthProtocolTests.pas`
   - `/tmp/sb_pascal_reg_bin/ConnectionAuthProtocolTests`
   - `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_reg_build -FE/tmp/sb_pascal_reg_bin ./tracks/p3/drivers/pascal/tests/TxnExecParityTests.pas`
