...
1. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FE./tracks/p3/drivers/pascal/tests ./tracks/p3/drivers/pascal/tests/TxnExecParityTests.pas`
- Result: PASS (compile succeeded).

2. `./tracks/p3/drivers/pascal/tests/TxnExecParityTests`
- Result: PASS (`TxnExecParityTests: OK`).

3. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FE./tracks/p3/drivers/pascal/tests ./tracks/p3/drivers/pascal/tests/SqlTests.pas`
- Result: PASS (compile succeeded).

4. `./tracks/p3/drivers/pascal/tests/SqlTests`
- Result: PASS (`SqlTests: OK`).

5. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_txn_opts_build -FE/tmp/sb_pascal_txn_opts_bin ./tracks/p3/drivers/pascal/tests/AdapterTransactionOptionsTests.pas`
- Result: PASS (compile succeeded).

6. `/tmp/sb_pascal_txn_opts_bin/AdapterTransactionOptionsTests`
- Result: PASS (`AdapterTransactionOptionsTests: OK`).

7. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_txn_state_build -FE/tmp/sb_pascal_txn_state_bin ./tracks/p3/drivers/pascal/tests/TxnStateTransitionsTests.pas`
- Result: PASS (compile succeeded).

8. `/tmp/sb_pascal_txn_state_bin/TxnStateTransitionsTests`
- Result: PASS (`TxnStateTransitionsTests: OK`).

9. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_next -FE/tmp/sb_pascal_next ./tracks/p3/drivers/pascal/tests/IntegrationTest.pas`
- Result: PASS (compile succeeded).
