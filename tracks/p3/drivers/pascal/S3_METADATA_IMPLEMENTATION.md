...
1. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FE./tracks/p3/drivers/pascal/tests ./tracks/p3/drivers/pascal/tests/MetadataRecursiveSchemaTests.pas`
- Result: PASS (compile succeeded).

2. `./tracks/p3/drivers/pascal/tests/MetadataRecursiveSchemaTests`
- Result: PASS (`MetadataRecursiveSchemaTests: OK`).

3. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_meta_adapter_build -FE/tmp/sb_pascal_meta_adapter_bin ./tracks/p3/drivers/pascal/tests/AdapterMetadataApiTests.pas`
- Result: PASS (compile succeeded).

4. `/tmp/sb_pascal_meta_adapter_bin/AdapterMetadataApiTests`
- Result: PASS (`AdapterMetadataApiTests: OK`).

5. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_meta_exec_build -FE/tmp/sb_pascal_meta_exec_bin ./tracks/p3/drivers/pascal/tests/MetadataExecutionFlowTests.pas`
- Result: PASS (compile succeeded).

6. `/tmp/sb_pascal_meta_exec_bin/MetadataExecutionFlowTests`
- Result: PASS (`MetadataExecutionFlowTests: OK`).

7. `fpc -Mdelphi -Fu./tracks/p3/drivers/pascal/src -FU/tmp/sb_pascal_next -FE/tmp/sb_pascal_next ./tracks/p3/drivers/pascal/tests/IntegrationTest.pas`
- Result: PASS (compile succeeded).
