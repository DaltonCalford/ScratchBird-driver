...
| META | JDBCBL-META | Gap | `src/lib.rs:11`, `src/metadata.rs:9`, `src/metadata.rs:12`, `src/metadata.rs:15`, `src/metadata.rs:18`, `src/metadata.rs:24`, `src/metadata.rs:27`, `src/metadata.rs:30` |
