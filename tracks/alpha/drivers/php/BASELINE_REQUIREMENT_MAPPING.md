...
| META | JDBCBL-META | Partial | [src/Metadata.php#L27](src/Metadata.php#L27), [src/Metadata.php#L82](src/Metadata.php#L82), [src/Metadata.php#L115](src/Metadata.php#L115), [src/Connection.php#L109](src/Connection.php#L109), [src/Connection.php#L946](src/Connection.php#L946), [tests/MetadataRecursiveSchemaTest.php#L19](tests/MetadataRecursiveSchemaTest.php#L19), [tests/MetadataExecutionTest.php#L22](tests/MetadataExecutionTest.php#L22), [tests/MetadataExecutionTest.php#L33](tests/MetadataExecutionTest.php#L33), [tests/MetadataExecutionTest.php#L44](tests/MetadataExecutionTest.php#L44), [tests/MetadataExecutionTest.php#L64](tests/MetadataExecutionTest.php#L64) |
...
- META: Lane metadata now includes executable collection routing through `Connection::getSchema(...)` with extended family coverage (catalog/key/privilege/type/routine), alias normalization, and wire-level execution tests; status remains `Partial` pending live integration assertions and richer restriction-aware metadata shaping.
