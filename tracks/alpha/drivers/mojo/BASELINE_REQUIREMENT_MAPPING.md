...
- `src/scratchbird_native.mojo:632` (native-bootstrap connect guards: TLS/binary/compression/mode/user+db)
- `src/scratchbird_native.mojo:650` (native-bootstrap `connect` entrypoint)
- `src/scratchbird_native.mojo:275` (native-bootstrap `ping` surface)
...
- `src/scratchbird_native.mojo:256` (native-bootstrap pipeline queue guard with SQLSTATE `54000`)
...
- `src/scratchbird_native.mojo:279` (native-bootstrap `query_metadata`)
- `src/scratchbird_native.mojo:283` (native-bootstrap `query_metadata_rows`)
- `src/scratchbird_native.mojo:584` (native-bootstrap metadata alias normalization)
- `src/scratchbird_native.mojo:597` (native-bootstrap metadata query resolution)
...
- `src/scratchbird_native.mojo:428` (native-bootstrap unsupported query `0A000`)
- `src/scratchbird_native.mojo:442` (native-bootstrap unsupported parameterized query `0A000`)
- `src/scratchbird_native.mojo:629` (native-bootstrap unsupported metadata `0A000`)
- `src/scratchbird_native.mojo:632` (native-bootstrap guard SQLSTATE error mapping)
- `src/scratchbird_native.mojo:660` (`extract_sqlstate` helper)
...
- `tests/native_bootstrap.mojo:255` (unsupported query `0A000` extraction assertion)
...
- `src/scratchbird_native.mojo:249` (native-bootstrap pre-operation circuit-breaker/keepalive validation hook)
- `src/scratchbird_native.mojo:256` (native-bootstrap pipeline-capacity queue guard with SQLSTATE `54000`)
- `src/scratchbird_native.mojo:262` (native-bootstrap post-operation circuit-breaker + keepalive + telemetry update hook)
...
- `src/scratchbird_native.mojo:310` (native-bootstrap stream close semantics)
