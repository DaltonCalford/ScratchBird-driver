...
- `src/scratchbird_native.mojo:718` (native-bootstrap metadata restriction comparator supports exact + wildcard (`LIKE`) predicates)
- `src/scratchbird_native.mojo:841` (native-bootstrap restriction-aware multi-restriction query resolution + `07001` count guard)
...
- `src/scratchbird.py:1302` (bridge-shim metadata restriction comparator supports exact + wildcard (`LIKE`) predicates)
- `src/scratchbird.py:1426` (bridge-shim restriction mapping normalizer + `22023` guard for non-mapping inputs)
- `src/scratchbird.py:1457` (bridge-shim restriction-aware multi-restriction query resolution)
- `src/scratchbird.py:1594` (`build_ddl_editor_schema_payload(...)` deterministic editor payload builder)
- Lane-local test anchors:
...
- `tests/metadata_execution.py:138` (bridge-shim multi-restriction query-shaping + mapping guard coverage)
- `tests/metadata_execution.py:200` (bridge-shim restricted multi-restriction execution routing coverage)
- `tests/metadata_execution.py:251` (bridge-shim restricted multi-restriction rowcount helper coverage)
