...
- `src/scratchbird_native.mojo:718` (native-bootstrap metadata restriction comparator supports exact + wildcard (`LIKE ... ESCAPE '\'`) predicates)
- `src/scratchbird_native.mojo:840` (native-bootstrap restriction-aware multi-restriction query resolution + `07001` count guard)
...
- `src/scratchbird.py:1377` (bridge-shim metadata restriction comparator supports exact + wildcard (`LIKE ... ESCAPE '\'`) predicates)
- `src/scratchbird.py:1501` (bridge-shim restriction mapping normalizer + `22023` guard for non-mapping inputs)
- `src/scratchbird.py:1532` (bridge-shim restriction-aware multi-restriction query resolution)
- `src/scratchbird.py:1669` (`build_ddl_editor_schema_payload(...)` deterministic editor payload builder)
- Lane-local test anchors:
...
- `tests/metadata_execution.py:148` (bridge-shim multi-restriction query-shaping + mapping guard coverage)
- `tests/metadata_execution.py:218` (bridge-shim restricted multi-restriction execution routing coverage)
- `tests/metadata_execution.py:269` (bridge-shim restricted multi-restriction rowcount helper coverage)
- `tests/metadata_execution.py:280` (bridge-shim editor payload helper path with schema-pattern restriction shaping)
- `tests/metadata_execution.py:311` (bridge-shim SQL LIKE escape-aware/case-insensitive matcher coverage)
