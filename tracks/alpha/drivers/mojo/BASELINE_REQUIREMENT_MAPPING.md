...
- `src/scratchbird_native.mojo:52` (native-bootstrap DSN host/port extraction + query override support for transport-ready endpoint fields, including bracketed IPv6 hosts)
