...
- `src/scratchbird_native.mojo:982` (native-bootstrap connect guards: TLS/binary/compression/mode/user+db + endpoint/timeout guardrails (including `port` upper bound) + deterministic auth-fail parity)
