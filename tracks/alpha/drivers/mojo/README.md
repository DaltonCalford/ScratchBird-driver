...
- `SCRATCHBIRD_MOJO_DISABLE_FALLBACK_DSN` to require explicit `SCRATCHBIRD_MOJO_URL` for integration/conformance (default lane behavior uses deterministic fallback DSN)
