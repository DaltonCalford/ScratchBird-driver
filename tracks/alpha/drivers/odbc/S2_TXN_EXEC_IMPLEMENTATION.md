...
- `./build/tracks/alpha/drivers/odbc/scratchbird_odbc_tests --gtest_filter='OdbcTransactionTest.EnvHandleEndTranCommitsConnectedConnections:OdbcExecutionParityTest.ExecuteAndExecDirectPropagateSuccessWithInfo'` -> PASS (2/2)
- `./build/tracks/alpha/drivers/odbc/scratchbird_odbc_tests --gtest_filter='OdbcAutocommitTest.*:OdbcTransactionTest.EnvHandleEndTranCommitsConnectedConnections:OdbcExecutionParityTest.ExecuteAndExecDirectPropagateSuccessWithInfo'` -> PASS (4/4)
