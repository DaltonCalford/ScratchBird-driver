...
| `META` | `JDBCBL-META` | `Partial` | `metadata.go:17`, `metadata.go:45`, `metadata.go:67`, `config.go:39`, `config.go:224`, `metadata_test.go:15`, `metadata_test.go:29`, `metadata_test.go:54`, `metadata_test.go:67`, `config_test.go:89` (metadata SQL helpers now include recursive schema parent expansion + tree shaping helpers with lane tests; no driver-level metadata execution API surface yet) |
